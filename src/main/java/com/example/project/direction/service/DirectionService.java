...
public class DirectionService {
    ...
    public String findDirectionUrlById(String encodingId){
        Long decodeId = base62Service.decodeDirectionId(encodingId);
    ...
    public List<Direction> buildDirectionList(DocumentDto documentDto){
        // 약국 데이터 조회
        // 거리 계산 알고리즘을 이용하여 약국 사이의 거리를 계산 sort
        ...
        return pharmacySearchService.searchPharmacyDtoList()
                ...
                .sorted(Comparator.comparing(Direction::getDistance)) // 거리순으로
                .limit(MAX_SEARCH_COUNT) //3개까지만 불러오게
    ...
    // double lat1, double lon1 고객의 위도 경도
    // double lat2, double lon2 약국의 위도 경도
